...
- Validate correct usage of PMCI-defined protocols (PLDM, MCTP, and SPDM) on OpenBMC-based systems.
...
including testing via PMCI-defined PTTI (Platform Test Tool Interface) or equivalent mechanisms.
